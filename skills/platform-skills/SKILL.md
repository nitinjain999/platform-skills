...
- `/platform-skills:awesome-docs` — generate animated demo docs from scratch, convert existing Markdown to animated, update individual diagrams, diff for staleness, audit quality, preview locally, or export to Confluence/Notion HTML
