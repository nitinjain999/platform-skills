...
Platform skills ships 43 command workflows. In Claude Code they are slash commands (`/platform-skills:preflight`). In Copilot Chat and Cursor Chat you phrase them as natural language — the instructions or rules files make the assistant apply the same structured output.
