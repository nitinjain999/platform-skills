...
| `/platform-skills:awesome-docs` | Generate animated demo docs, convert existing Markdown to animated, update diagrams, diff for staleness, audit quality, preview locally, export to Confluence/Notion |
