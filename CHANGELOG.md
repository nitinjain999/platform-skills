...
- `examples/aws/cloudfront/` — production-ready Terraform module:
  - `versions.tf` — provider constraints (`aws ~> 5.0`, `archive ~> 2.4`), `us_east_1` alias, `required_version = ">= 1.5.0"`
